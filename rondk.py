...
class RondkBot:
    def __init__(self):
        ...
        # Dosya yolları (Railway'de kalıcı)
    ...
    async def cevap_ver(self, update, context, bekleme_suresi):
        ...
        # Yapay zeka prompt'u
        prompt = f"""
Sen 23 yaşında, Duhoklu bir kızsın. İsmin Rondk.
...
"""
    ...
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        yanit_var = mesaj.reply_to_message and mesaj.reply_to_message.from_user.id == context.bot.id
